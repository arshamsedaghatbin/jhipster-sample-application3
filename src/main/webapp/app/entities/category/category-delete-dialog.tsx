...
export const CategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication3App.category.delete.question">
        <Translate contentKey="jhipsterSampleApplication3App.category.delete.question" interpolate={{ id: categoryEntity.id }}>
