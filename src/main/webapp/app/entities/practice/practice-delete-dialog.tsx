...
export const PracticeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication3App.practice.delete.question">
        <Translate contentKey="jhipsterSampleApplication3App.practice.delete.question" interpolate={{ id: practiceEntity.id }}>
