  ...
  return (
    <div>
      <h2 id="sub-category-heading" data-cy="SubCategoryHeading">
        <Translate contentKey="jhipsterSampleApplication3App.subCategory.home.title">Sub Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication3App.subCategory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication3App.subCategory.home.createLabel">Create new Sub Category</Translate>
          </Link>
        </div>
      </h2>
        ...
        {subCategoryList && subCategoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication3App.subCategory.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="jhipsterSampleApplication3App.subCategory.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('photo')}>
                  <Translate contentKey="jhipsterSampleApplication3App.subCategory.photo">Photo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {subCategoryList.map((subCategory, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`jhipsterSampleApplication3App.AccountType.${subCategory.accountType}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication3App.subCategory.home.notFound">No Sub Categories found</Translate>
            </div>
          )
        )}
      </div>
